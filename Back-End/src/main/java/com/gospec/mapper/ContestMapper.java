...
public interface ContestMapper {
	...
	public List<ContestDto> findByBestBookMark(@Param("type") String type);
	...
	public List<ContestDto> findByBookMarkWithField(@Param("username") String username, @Param("type") String type);
}
